    ...
    <section class="border-t border-slate-200/80 bg-gradient-to-b from-slate-50 to-white py-16 sm:py-20">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between sm:gap-8">
                <div class="max-w-2xl">
                    <h2 class="text-4xl font-extrabold leading-tight text-brand-dark sm:text-5xl"><span class="text-brand-blue">Avis</span> clients</h2>
                    <p class="mt-3 text-base text-slate-600 sm:text-lg">Ils nous font confiance pour leurs travaux de rénovation. Découvrez tous les retours sur notre fiche Google.</p>
                </div>
                <a href="https://share.google/14Nu70a8PfwWT4P4p" target="_blank" rel="noopener noreferrer" class="inline-flex shrink-0 items-center justify-center gap-2 rounded-xl border-2 border-brand-dark/15 bg-white px-5 py-3 text-sm font-extrabold text-brand-dark shadow-sm ring-1 ring-slate-200/80 transition hover:border-brand-blue/40 hover:bg-slate-50 hover:text-brand-blue hover:shadow-md sm:self-start lg:self-auto">
            ...
            <div class="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6">
                <article class="relative flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200/90 bg-white p-6 shadow-soft ring-1 ring-slate-100 transition duration-300 hover:-translate-y-0.5 hover:border-brand-blue/25 hover:shadow-lg">
                    <div class="absolute -right-2 -top-2 h-16 w-16 rounded-full bg-brand-blue/5" aria-hidden="true"></div>
                    ...
                    <p class="relative flex-1 text-sm leading-relaxed text-slate-700 sm:text-base">Équipe sérieuse, chantier propre et très bon résultat.</p>
                    <p class="relative mt-5 border-t border-slate-100 pt-4 text-sm font-extrabold text-brand-dark">Claire M.</p>
                </article>
                <article class="relative flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200/90 bg-white p-6 shadow-soft ring-1 ring-slate-100 transition duration-300 hover:-translate-y-0.5 hover:border-brand-blue/25 hover:shadow-lg">
                    <div class="absolute -right-2 -top-2 h-16 w-16 rounded-full bg-brand-yellow/10" aria-hidden="true"></div>
                    <div class="relative mb-4 flex items-start justify-between gap-3">
                        <p class="text-lg tracking-wide text-yellow-500" aria-label="5 sur 5">★★★★★</p>
                        <span class="rounded-full bg-slate-100 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-slate-600">Google</span>
                    </div>
                    <p class="relative flex-1 text-sm leading-relaxed text-slate-700 sm:text-base">Accompagnement pro du début à la fin et très bons conseils.</p>
                    <p class="relative mt-5 border-t border-slate-100 pt-4 text-sm font-extrabold text-brand-dark">Julien R.</p>
                </article>
                <article class="relative flex h-full flex-col overflow-hidden rounded-2xl border border-slate-200/90 bg-white p-6 shadow-soft ring-1 ring-slate-100 transition duration-300 hover:-translate-y-0.5 hover:border-brand-blue/25 hover:shadow-lg">
                    <div class="absolute -right-2 -top-2 h-16 w-16 rounded-full bg-emerald-500/10" aria-hidden="true"></div>
                    <div class="relative mb-4 flex items-start justify-between gap-3">
                        <p class="text-lg tracking-wide text-yellow-500" aria-label="5 sur 5">★★★★★</p>
                        <span class="rounded-full bg-slate-100 px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wide text-slate-600">Google</span>
                    </div>
                    <p class="relative flex-1 text-sm leading-relaxed text-slate-700 sm:text-base">Travail de qualité, délais tenus et équipe très à l'écoute.</p>
                    <p class="relative mt-5 border-t border-slate-100 pt-4 text-sm font-extrabold text-brand-dark">Sophie L.</p>
                </article>
            </div>
        </div>
    </section>
