            ...
            <div class="flex h-full flex-col">
                ...
                <div class="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-soft ring-1 ring-slate-100">
                    ...
                    <div class="relative z-10 p-3 sm:p-4">
                        <div id="avisCarousel"
                             class="flex w-full gap-0 overflow-x-hidden scroll-smooth snap-x snap-mandatory pb-2 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:overflow-x-auto">
                    @foreach (data_get($h, 'avis.testimonials', []) as $t)
                        ...
                        <article class="relative w-full min-w-full flex-shrink-0 overflow-hidden rounded-2xl border border-slate-200/90 bg-white p-6 snap-start">
                            ...
                            <p class="relative mb-4 break-words text-sm leading-relaxed text-slate-700 sm:text-base">{{ $text }}</p>
