        ...
        <nav class="hidden items-center gap-1 lg:flex xl:gap-2" aria-label="Navigation principale">
            ...
            >
                ...
                <span class="flex flex-col leading-none">
                    ...
                    <span class="text-[11px] font-bold text-yellow-500">{{ data_get($h, 'sidebar_avis.stars', '★★★★★') }} <span class="ml-1 text-slate-500">{{ data_get($h, 'sidebar_avis.text', '+100 avis') }}</span></span>
                </span>
            </a>
        </nav>
