...
@include('home.head', [
    'home'         => $h,
    'title'        => 'Candidature reçue | ' . $siteName,
    'description'  => 'Votre dossier de candidature franchise a bien été transmis. Un expert vous recontacte sous peu.',
    'canonicalUrl' => route('franchise.success'),
])
    ...
    <main class="mx-auto flex min-h-screen w-[95%] max-w-3xl items-center px-4 py-10 sm:px-6 lg:px-8">
        <section class="w-full rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-soft sm:p-10">
            ...
            <p class="mt-4 text-sm leading-relaxed text-slate-600 sm:text-base">
                Merci pour votre intérêt pour la franchise Normes Rénovation. Un expert de notre réseau va étudier votre dossier et vous recontacter sous peu.
            </p>
            @if($phone !== '')
