...
@section('content')
    <div class="mb-6 flex flex-wrap items-start justify-between gap-4">
        ...
        <div class="flex flex-wrap items-center gap-2">
            {{-- Bouton import WordPress via API --}}
            <form method="post" action="{{ route('admin.legacy_pages.import_wordpress') }}"
                  onsubmit="return confirm('Supprimer toutes les pages non verrouillées et relancer l\'import depuis WordPress ? Cela peut prendre 3–5 minutes selon le nombre d\'annonces.')">
                @csrf
                <button type="submit"
                    ...
                    Reimporter depuis WordPress (API)
                </button>
            </form>
