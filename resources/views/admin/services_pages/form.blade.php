    ...
    <form method="post" action="{{ $isEdit ? route('admin.services_pages.update', $page) : route('admin.services_pages.store') }}" class="space-y-5">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5">
            ...
            <div class="mt-4 rounded-xl border border-slate-200 bg-slate-50/70 p-4">
                ...
                <div class="mt-3 grid gap-3 lg:grid-cols-2">
                    <input name="content_overrides[avis][title_accent]" value="{{ old('content_overrides.avis.title_accent', data_get($ov, 'avis.title_accent', 'Avis')) }}" placeholder="Titre avis - partie couleur" class="rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-200" />
                    <input name="content_overrides[avis][title_rest]" value="{{ old('content_overrides.avis.title_rest', data_get($ov, 'avis.title_rest', 'clients')) }}" placeholder="Titre avis - partie non couleur" class="rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-200" />
                </div>
