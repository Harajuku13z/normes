@php
    ...
    $titleAccent = trim((string) data_get($ov, 'title_accent', (string) data_get($h, 'avis.title_accent', (string) data_get($defaultAvis, 'title_accent', 'Ce que nos clients pensent de nous'))));
    $titleRest = trim((string) data_get($ov, 'title_rest', (string) data_get($h, 'avis.title_rest', (string) data_get($defaultAvis, 'title_rest', ': avis client'))));
